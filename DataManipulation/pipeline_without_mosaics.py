...
for region in regions:
    ...
    for area in areas_in_region:
        ...
        data_utils.generate_patches_from_shapefile_and_raster_patches(input_tif = output_file_path, input_shapefile = desired_shapefile,  output_directory_images = image_patch_outputs_folder,output_directory_shapepatches = shapefile_patch_outputs,region_name = area, file_format = 'jpg',patch_size=(640, 640))
